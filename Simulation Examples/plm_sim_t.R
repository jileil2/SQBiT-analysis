...
tikz(paste0('plm_t2_homo_n', n, '_truth_beta0_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
...
tikz(paste0('plm_t2_homo_n', n, '_truth_beta1_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = pop.r[, 1], y = pop.r[, 2], duplicate = "mean",
...
# qplvcm beta0
tikz(paste0('plm_t2_homo_n', n, '_QBiT_beta0_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = S.pop[, 1], y = S.pop[, 2], duplicate = "mean",
              z = mhat[, 1], nx = 140, ny = 140)
heat.2d.hs(int, zlim = c(-5, 5.5), 
           col = tim.colors(64), legend = FALSE,
           outside.color = 'black')
polygon(rbind(boundary, c(3.5, 0.9),
              c(-0.9, 0.9),
              c(-0.9, -0.9),
...
# qplvcm beta1
tikz(paste0('plm_t2_homo_n', n, '_QBiT_beta1_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = S.pop[, 1], y = S.pop[, 2], duplicate = "mean",
...
# sqplvcm beta0
tikz(paste0('plm_t2_homo_n', n, '_SQBiT_beta0_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = S.pop[, 1], y = S.pop[, 2], duplicate = "mean",
...
# sqplvcm beta1
tikz(paste0('plm_t2_homo_n', n, '_SQBiT_beta1_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = S.pop[, 1], y = S.pop[, 2], duplicate = "mean",
...
# tps beta0
tikz(paste0('plm_t2_homo_n', n, '_tps_beta0_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
...
# tps beta1
tikz(paste0('plm_t2_homo_n', n, '_tps_beta1_tau', tau * 100, '.tex'), width = 4, height = 3, standAlone = TRUE)
int <- interp(x = S.pop[, 1], y = S.pop[, 2], duplicate = "mean",
